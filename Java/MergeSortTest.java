 ...
 * @since       2013.07.05
 * @version     1.0
 * @link        GitHub  https://github.com/z3ppelin/MergeSort
...
public class MergeSortTest {
    ...
    /**
     * Test case for MergeSort.merge();
     */
    @Test
    public void mergeTest() {
        int[] merged1 = MergeSort.merge(this.mergeV11, this.mergeV12);
        assertEquals("merged 1 length is not ok", this.mergeV11.length + this.mergeV12.length, merged1.length);

        int[] merged2 = MergeSort.merge(this.mergeV12, this.mergeV11);
        ...
        int[] merged3 = MergeSort.merge(this.mergeV21, this.mergeV22);
        assertEquals("merged 3 length is not ok", this.mergeV21.length + this.mergeV22.length, merged3.length);

        int[] merged4 = MergeSort.merge(this.mergeV22, this.mergeV21);
        ...
        int[] merged5 = MergeSort.merge(this.mergeV11, this.mergeV22);
        assertEquals("merged 5 length is not ok", this.mergeV11.length + this.mergeV22.length, merged5.length);

        int[] merged6 = MergeSort.merge(this.mergeV22, this.mergeV11);
    ...
    /**
     * Test case for MergeSort.mergeSort();
     */
    @Test
    public void mergeSortTest() {
        int[] sorted1 = MergeSort.mergeSort(this.arrayToSort1);
        ...
        int[] sorted2 = MergeSort.mergeSort(this.arrayToSort2);
